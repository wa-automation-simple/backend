        ...
        try:
            ...
            roles_data = [
                ...
                },
                {
                    ...
                    "is_system": True,
                    "permission_names": ["user:read"],  # Can only read own profile
                },
            ]
            ...
            for role_data in roles_data:
                ...
                if existing_role:
                    ...
                    print(
                        f"  ✓ Created role '{role_data['name']}' with {len(permissions)} permissions"
                    )
            ...
            for user_data in users_data:
                ...
                if existing_user:
                    ...
                    print(
                        f"  ✓ Created user '{user_data['email']}' with roles: {', '.join(user_data['role_names'])}"
                    )
